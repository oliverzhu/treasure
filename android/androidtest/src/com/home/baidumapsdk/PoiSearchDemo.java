...
//            String[] keys = {"麦当劳", "肯德基"};
//            GeoPoint  ptLB = new GeoPoint(39874635, 116319469);
//            GeoPoint  ptRT = new GeoPoint(39975119, 116443076);
//            mSearch.poiMultiSearchNearBy(keys, ptLB, 100000);
//            mSearch.poiMultiSearchInbounds(keys, ptLB, ptRT);
            
//          Intent intent = null;
//          intent = new Intent(PoiSearchDemo.this, BaseMapDemo.class);
