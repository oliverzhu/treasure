 ...
 */
package com.client.customerservicecenter.widget.vpi;
...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private void addTab(int index, CharSequence text, int iconResId,int count) {
        ...
        tabView.setTextColor(getResources().getColorStateList(R.color.title_selector));

//        if (iconResId != 0) {
//            tabView.setCompoundDrawablesWithIntrinsicBounds(0, iconResId, 0, 0);
//        }
        
        tabView.setBackgroundResource(R.drawable.title_bar_whole_selector);
