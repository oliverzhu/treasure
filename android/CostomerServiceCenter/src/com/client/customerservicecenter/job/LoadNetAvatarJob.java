...
import com.client.customerservicecenter.hub.CloudLoginHandler;
 ...
 * @since 2014/9/29
 */
public class LoadNetAvatarJob extends ImageCacheRequestJob {
	private static final String TAG = "LocalImageRequestJob";
    private String avatarKey;
    private Map<String,String> userInfoMap;
	public LoadNetAvatarJob(Context context, Map<String,String> userInfoMap,
	...
	public Bitmap onDecodeOriginal(JobContext jc, final int type) {
		...
		if(!f.exists())
		{
			CloudLoginHandler testCloudService = CloudLoginHandler.getInstance(context);
