 ...
 * 2013/6/14
 */
public class CommentInfoHandler extends IHandler<CommentInfo> {
	//反馈id
	...
	private CommentInfoHandler() {
	}

	private static CommentInfoHandler instance = new CommentInfoHandler();

	public static CommentInfoHandler getInstance() {
		return instance;
	}
