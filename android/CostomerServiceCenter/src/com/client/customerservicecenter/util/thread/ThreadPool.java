...
package com.client.customerservicecenter.util.thread;
...
public class ThreadPool {
    ...
    // M: in order to take full advantage of MT6589 CPU Core, change cpuCounter to 4 from 2 
    ...
    public <T> Future<T> submit(Job<T> job, FutureListener<T> listener,int threadMode) {
