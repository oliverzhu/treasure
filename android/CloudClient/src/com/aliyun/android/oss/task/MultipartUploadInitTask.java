...
//        }
    ...
    protected HttpUriRequest generateHttpRequest() {
        ...
        if (httpTool.getIsUploads()) {
            httpPost.setHeader(UPLOADS, null);
        }
    ...
    public String getResult() {
        try {
            ...
            if (uploadId == null) {
                OSSException ossException = new OSSException("no UploadId returned by OSS server.");
                ossException.setErrorCode(OSSErrorCode.NO_UPLOADID_RETURN);
                throw ossException;
            }
