...
public class TableInfo {
    ...
    public static  TableInfo get(Class<?> clazz){
        ...
        if( tableInfo == null ){
            ...
            if (sPrefix == null) {
                throw new RuntimeException("App key must be set before create table! " +
                        "example: TableInfo.setPrefix(prefix)");
            }
            @SuppressWarnings("static-access")
            StringBuffer tableName = new StringBuffer(tableInfo.getPrefix());
            tableName.append("__").append(ClassUtils.getTableName(clazz));
            tableInfo.setTableName(tableName.toString().toLowerCase(Locale.getDefault()));
            ...
            if(idField != null){
                ...
                id.setSet(FieldUtils.getFieldSetMethod(CloudObject.class, idField));
                id.setGet(FieldUtils.getFieldGetMethod(CloudObject.class, idField));
    ...
    public static void setPrefix(String prefix) {
        TableInfo.sPrefix = prefix.replace('.', '_');
    }
}
