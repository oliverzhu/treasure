...
public class InformationDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        mView = getLayoutInflater().inflate(R.layout.information_dialog_myos, null);
...
//        }
        ...
        View titleView = LayoutInflater.from(mContext).inflate(R.layout.information_dialog_title_view, null);
        ...
        title.setText(mFileInfo.fileName);
