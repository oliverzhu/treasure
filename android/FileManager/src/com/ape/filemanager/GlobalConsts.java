...
public abstract class GlobalConsts {
    ...
    public static final String TINNO_ROOT_PATH = "/storage";
    
    public static final String TINNO_USBOTG_NAME = "usbotg";
    ...
    public static final String ACTION_SCAN_FILES_COMPLETED = "android.fileexplorer.scan.completed";
    public static final String CLOUD_ACTION_SDCARD_CHANGED = "cloud.file.sdcard.changed";
}
