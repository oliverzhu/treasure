...
public class FileCategoryActivity extends Fragment implements IFileInteractionListener,
        ...
        mSearchView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                        ...
                        && Util.isSDCardReady())
                {
                    ...
                    activity.startSearchActivity(Util.getTinnoRootPath());
                }
            }
        });
    }
    ...
    private void setupCategoryInfo() {
        ...
        mCategoryBar.addCategory(R.drawable.category_bar_app_mm);
        categoryIndex.put(FileCategory.app_MM, 0);
        mCategoryBar.addCategory(R.drawable.category_bar_other);
        categoryIndex.put(FileCategory.Other, 1);
//        int[] imgs = new int[] {
...
//        }
    ...
    public void refreshCategoryInfo() {
        ...
        SDCardInfo sdCardInfo = Util.getSDCardInfoFromPaths(mMountPointManager.getMountPointPaths());
        if (sdCardInfo != null) {
        ...
        long size = 0;
        if (sdCardInfo != null) {
        	CategoryInfo categoryInfo = mFileCagetoryHelper.getCategoryInfos().get(FileCategory.app_MM);
        	size = categoryInfo.size;
        	setCategoryBarValue(FileCategory.app_MM, size);
    ...
    private void setupClick() {
        ...
        if (OptionsUtils.isHaveFavorite(mActivity))
        {
...
//                return R.id.category_theme_count;
    ...
    private void setCategorySize(FileCategory fc, long size) {
        ...
        switch (fc) {
            ...
            case Apk:
                ...
                break;
            case Other:
                txtId = R.id.category_legend_others;
                resId = R.string.category_other;
                break;
                
            case app_MM:
            	txtId = R.id.category_legend_app_mm;
            	resId = R.string.category_app_mm;
            	break;
    ...
    {
        return (ListView) mRootView.findViewById(R.id.file_path_list);
    }
}
