...
import com.ape.filemanager.MediaFile.MediaFileType;
...
public class FileCategoryHelper {
    ...
    private static String[] DOC_EXTS ={"txt", "log", "xml", "ini", "lrc"};
    ...
    public static HashMap<FileCategory, Integer> categoryIcons = new HashMap<FileCategory, Integer>();
    ...
    static {
        categoryIcons.put(FileCategory.Music, R.drawable.category_icon_music);
        categoryIcons.put(FileCategory.Video, R.drawable.category_icon_video);
        categoryIcons.put(FileCategory.Picture, R.drawable.category_icon_picture);
        categoryIcons.put(FileCategory.Doc, R.drawable.category_icon_document);
        categoryIcons.put(FileCategory.Zip, R.drawable.category_icon_zip);
        categoryIcons.put(FileCategory.Apk, R.drawable.category_icon_apk);
        categoryIcons.put(FileCategory.Favorite, R.drawable.category_icon_favorite);
        categoryNames.put(FileCategory.Theme, R.drawable.category_icon_theme);
    }
    ...
    public static FileCategory[] sCategories = new FileCategory[] {
            ...
            FileCategory.Doc, FileCategory.Zip, FileCategory.Apk, FileCategory.Other, FileCategory.app_MM
    };
    ...
    public int getCategoryNameId(FileCategory category)
    {
        return categoryNames.get(category);
    }
    
    public int getCategoryIconId(FileCategory category)
    {
...
//        }
    ...
    public void refreshCategoryInfo() {
        ...
        setCategoryInfo(FileCategory.app_MM, mMultiMediaTotal, mMultiMediaSize);
    }
