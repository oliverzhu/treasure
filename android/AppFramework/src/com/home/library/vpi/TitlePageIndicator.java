...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    private int mInitBackGroundPaintAlpha;
    
    private boolean mFades = false;
    ...
    private int setPaintAlpha()
    {
    	final int mPaintTextAlpha = Math.max(mPaintText.getAlpha() - mFadeBy, 0);
    	mPaintText.setAlpha(mPaintTextAlpha);
        final int mPaintFooterLinAlphae = Math.max(mPaintFooterLine.getAlpha() - mFadeBy, 0);
        mPaintFooterLine.setAlpha(mPaintFooterLinAlphae);
        final int mPaintFooterIndicatorAlpha = Math.max(mPaintFooterIndicator.getAlpha() - mFadeBy, 0);
        mPaintFooterIndicator.setAlpha(mPaintFooterIndicatorAlpha);
        final int mBackGroundPaintAlpha = Math.max(mBackGroundPaint.getAlpha() - mFadeBy, 0);
        mBackGroundPaint.setAlpha(mBackGroundPaintAlpha);
        
//        Log.d("mPaintText", mPaintTextAlpha +"");
//        Log.d("mPaintFooterLine", mPaintFooterLinAlphae+"");
//        Log.d("mPaintFooterIndicator", mPaintFooterIndicatorAlpha+"");
//        Log.d("mBackGroundPaint", mBackGroundPaintAlpha+"");
        
        int alpha = mPaintTextAlpha + mPaintFooterLinAlphae 
        		+ mPaintFooterIndicatorAlpha + mBackGroundPaintAlpha;
    ...
    public void setBackGroundColor(Canvas canvas)
    {
    	if(mScrollState != ViewPager.SCROLL_STATE_IDLE)
        {
    		mBackGroundPaint.setColor(mBackGroundColor);
        }
        Rect bgRect = new Rect(getLeft(),getTop(),getRight(),getBottom());
        canvas.drawRect(bgRect, mBackGroundPaint);
    }
