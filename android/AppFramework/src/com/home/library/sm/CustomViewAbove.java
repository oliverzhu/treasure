...
import com.home.library.sm.SlidingMenu.OnClosedListener;
import com.home.library.sm.SlidingMenu.OnOpenedListener;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			try {
				...
				if (DEBUG) Log.e(TAG, "pointerIndex:" + pointerIndex);
				e.printStackTrace();
			}
