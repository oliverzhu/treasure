...
public class BytesBufferPool {
	private static final String TAG = "BytesBufferPool";
    ...
    public static class BytesBuffer {
        ...
        public void readFrom(JobContext jc, FileDescriptor fd) throws IOException {
        	Log.i(TAG, "<readFrom> file:" + fd,Log.APP);
    ...
    public BytesBufferPool(int poolSize, int bufferSize) {
    	Log.i(TAG, "<BytesBufferPool> poolSize:" + poolSize + " bufferSize:" + bufferSize,Log.APP);
