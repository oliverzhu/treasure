...
public class RenamePlaylist extends Activity
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mRenameId < 0 || mOriginalName == null || defaultname == null) {
            Log.i(TAG, "Rename failed: " + mRenameId + "/" + defaultname,Log.APP);
            finish();
            return;
        }
            ...
            if (button == DialogInterface.BUTTON_POSITIVE) {
                ...
                if (name != null && name.length() > 0) {
                    ...
                    if (mExistingId >= 0) {
                        ...
                        Log.i(TAG, "to overwrite, delete the existing one",Log.APP);
                    }
    ...
    protected Dialog onCreateDialog(int id) {
        Log.i(TAG, "<onCreateDialog> id:" + id,Log.APP);
    ...
    final private BroadcastReceiver mScanListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            finish();
            Log.i(TAG, "SD card is ejected, finish RenamePlaylist activity!",Log.APP);
        }
    };
}
