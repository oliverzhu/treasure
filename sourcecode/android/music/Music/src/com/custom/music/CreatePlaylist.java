...
import com.custom.music.view.MusicDialog;
...
public class CreatePlaylist extends Activity
{
    ...
    private void setSaveButton() {
        ...
        if (mDialog == null) {
            Log.e(TAG, ">>> setSaveButton with dialog is null return!",Log.APP);
            return;
        }
        if (mSaveButton == null) {
        ...
        Log.i(TAG, "setSaveButton >>>  mSaveButton:" + mSaveButton,Log.APP);
    }
        ...
        public void onClick(DialogInterface dialogInterface, int button) {
            if (button == DialogInterface.BUTTON_POSITIVE) {
                ...
                if (name != null && name.length() > 0) {
                    ...
                    if (id >= 0
                            && (mPlaylistFlag.equals(MusicUtils.NEW_PLAYLIST) || (mPlaylistFlag
                                    .equals(MusicUtils.SAVE_AS_PLAYLIST) && !name.equals(mPlaylistName)))) {
                    ...
                    } else if (id >= 0 && name.equals(mPlaylistName)
                            && mPlaylistFlag.equals(MusicUtils.SAVE_AS_PLAYLIST)) {
                        ...
                        try {
                            ...
                            Log.e(TAG, "OnClickListener() with UnsupportedOperationException:" + ex,Log.APP);
                            finish();
                            return;
                        }
    ...
    private BroadcastReceiver mScanListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            finish();
            Log.i(TAG, "SD card is ejected, finish CreatePlaylist activity!",Log.APP);
        }
    };
