    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        mToken = MusicUtils.bindToService(this, new ServiceConnection() {
            ...
            /// M: instantiate the IMediaPlaybackService object
                ...
                if (Intent.ACTION_VIEW.equals(action)) {
                    ...
                    if (b == null) {
                        Log.w(TAG, "Unexpected:getExtras() returns null.",Log.APP);
                    } else {
                        try {
                            ...
                            Log.e(TAG, "Playlist id missing or broken",Log.APP);
                        }
                    }
                    finish();
                    return;
        ...
        if (mAdapter == null) {
            ...
            if (mPlaylistCursor != null && oldRecentString != null &&
                ...
                Log.i(TAG, "old playlist cursor needs to be changed!",Log.APP);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (mPlaylistCursor == null) {
            Log.w(TAG, "Playlist cursor is null, need not show option menu!",Log.APP);
            return false;
        }
        ...
        switch (item.getItemId()) {
            ...
            case EDIT_PLAYLIST:
                if (mi.id == RECENTLY_ADDED_PLAYLIST) {
                    ...
                    Log.e(TAG, "should not be here",Log.APP);
                }
                break;
    ...
    protected void onListItemClick(ListView l, View v, int position, long id)
    {
        if (mCreateShortcut) {
            ...
            shortcut.setDataAndType(Uri.EMPTY, Constants.TRACK_MIME_TYPE);
    ...
    private Cursor getPlaylistCursor(AsyncQueryHandler async, String filterstring) {
        ...
        if(MusicUtils.isPlaylistNamePinyinKeyExist())
        {
    ...
    private Cursor mergedCursor(Cursor c) {
        ...
        if (c instanceof MergeCursor) {
            ...
            Log.i(TAG, "<mergedCursor> Already wrapped",Log.APP);
            return c;
        }
    ...
    static class PlaylistListAdapter extends SimpleCursorAdapter {
        ...
        class QueryHandler extends AsyncQueryHandler {
            ...
            protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
                ...
                if (null != cursor) {
                    Log.i(TAG, "<onQueryComplete> count:" + cursor.getCount(),Log.APP);
                } else {
                    Log.i(TAG, "<onQueryComplete> cursor is null",Log.APP);
                }
                /// @}
                if (cursor != null) {
                    try {
                    ...
                    /// M:  @{
                        ...
                        Log.e(TAG, "---------Exception: " + ex.toString(),Log.APP);
                        shouldFinish = true;
                }
                    /// @}
                }
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            tv.setTextAppearance(context, R.style.TextAppearance_primary_title_light);
